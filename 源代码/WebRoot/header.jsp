...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">网上冲印网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=1">普通冲印</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=2">证件照</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=3">拍立得冲印</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=4">大尺寸印刷照</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=5">时尚相框</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=6">DIY相册配件</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>OrderInfo/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的打印订单</li>
