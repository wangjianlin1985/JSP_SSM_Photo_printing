...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">套餐类别:</div>
	...
	<div class="row bottom15">
		...
		<div class="col-md-6 col-xs-6">
			<button onclick="makeOrder();" class="btn btn-primary">我要冲印</button>
...
function makeOrder() {
	location.href = "<%=basePath%>OrderInfo/orderInfo_userFrontAdd.jsp?productId=<%=product.getProductId() %>";
}
