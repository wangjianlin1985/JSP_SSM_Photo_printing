...
public class OrderInfoService {
    ...
    /*按照查询条件分页查询订单记录*/
    public ArrayList<OrderInfo> queryOrderInfo(Product productName,String telephone,OrderState orderStateObj,UserInfo userObj,String orderTime,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(null != productName && productName.getProductId()!= null && productName.getProductId()!= 0)  where += " and t_orderInfo.productName=" + productName.getProductId();
    	if(!telephone.equals("")) where = where + " and t_orderInfo.telephone like '%" + telephone + "%'";
    	if(null != orderStateObj && orderStateObj.getStateId()!= null && orderStateObj.getStateId()!= 0)  where += " and t_orderInfo.orderStateObj=" + orderStateObj.getStateId();
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<OrderInfo> queryOrderInfo(Product productName,String telephone,OrderState orderStateObj,UserInfo userObj,String orderTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != productName && productName.getProductId()!= null && productName.getProductId()!= 0)  where += " and t_orderInfo.productName=" + productName.getProductId();
    	if(!telephone.equals("")) where = where + " and t_orderInfo.telephone like '%" + telephone + "%'";
    	if(null != orderStateObj && orderStateObj.getStateId()!= null && orderStateObj.getStateId()!= 0)  where += " and t_orderInfo.orderStateObj=" + orderStateObj.getStateId();
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Product productName,String telephone,OrderState orderStateObj,UserInfo userObj,String orderTime) throws Exception {
     	String where = "where 1=1";
    	if(null != productName && productName.getProductId()!= null && productName.getProductId()!= 0)  where += " and t_orderInfo.productName=" + productName.getProductId();
    	if(!telephone.equals("")) where = where + " and t_orderInfo.telephone like '%" + telephone + "%'";
    	if(null != orderStateObj && orderStateObj.getStateId()!= null && orderStateObj.getStateId()!= 0)  where += " and t_orderInfo.orderStateObj=" + orderStateObj.getStateId();
