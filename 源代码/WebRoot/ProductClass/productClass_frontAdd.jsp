				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="productClassAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="productClass_className" class="col-md-2 text-right">套餐分类:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="productClass_className" name="productClass.className" class="form-control" placeholder="请输入套餐分类">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="productClass_classDesc" class="col-md-2 text-right">套餐描述:</label>
						  	 <div class="col-md-8">
							    <textarea id="productClass_classDesc" name="productClass.classDesc" rows="8" class="form-control" placeholder="请输入套餐描述"></textarea>
							 </div>
						  </div>
				          <div class="form-group">
